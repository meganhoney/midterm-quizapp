...
SELECT
  ...
  quizzes.topic,
  quizzes.public,
  char(quizzes.created_at,'Day MM/DD/YYYY HH:MM PM') As created_at
...
select to_char(created_at,'Day MM/DD/YYYY HH:MM PM') As created_at FROM RESULTS;
