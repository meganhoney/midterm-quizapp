...
*/
  ...
  const createQuizRow = function(quiz) {
    ...
    let $quiz = `
      <tr>
        ...
        <td>${quiz.topic}</td>
        <td>${dateString}</td>
        <td><a href="http://localhost:8080/${quiz.id}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Primary link</a></td>
      </tr>
    `;
  ...
  $('#share-button').click((event)=>{
    ...
    let hrefValue = this.href;//get the href property of the current clicked element
